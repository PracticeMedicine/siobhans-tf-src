...
void CGCClientSystem::InitGC()
{
	...
	void* pGenericInterface = pSteamClient->GetISteamGenericInterface(hSteamUser, hSteamPipe, STEAMREMOTESTORAGE_INTERFACE_VERSION);
...
#ifdef CLIENT_DLL
				GCSDK::CProtoBufMsg<CMsgClientHello> msg(4006);
...
#else
				GCSDK::CProtoBufMsg<CMsgServerHello> msg(4006);
