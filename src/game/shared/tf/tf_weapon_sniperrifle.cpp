...
//-----------------------------------------------------------------------------
bool CTFSniperRifleRevolver::CanFireCriticalShot(bool bIsHeadshot, CBaseEntity* pTarget)
{
	return CTFSniperRifle::CanFireCriticalShot(bIsHeadshot, pTarget);	// Skip TFC Sniper Rifle
}
