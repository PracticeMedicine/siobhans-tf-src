...
extern const char g_szFemaleModels[TF_LAST_NORMAL_CLASS][MAX_PATH];
...
enum ETFCond
{
	...
	TF_COND_NO_COMBAT_SPEED_BOOST	= 131,		// STAGING_ENGY
	TF_COND_TRANQ_SPY_BOOST = 132,			// STAGING_SPY
	TF_COND_TRANQ_MARKED = 133,
	TF_COND_STEALTHED_PHASE = 134,
	TF_COND_CLIP_OVERLOAD = 135,
	TF_COND_SPY_CLASS_STEAL = 136,
