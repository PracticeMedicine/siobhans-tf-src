...
DECLARE_SCRIPT_CONST( ETFCond, TF_COND_NO_COMBAT_SPEED_BOOST )
DECLARE_SCRIPT_CONST( ETFCond, TF_COND_TRANQ_SPY_BOOST )
DECLARE_SCRIPT_CONST( ETFCond, TF_COND_TRANQ_MARKED )
DECLARE_SCRIPT_CONST( ETFCond, TF_COND_STEALTHED_PHASE )
DECLARE_SCRIPT_CONST( ETFCond, TF_COND_CLIP_OVERLOAD )
DECLARE_SCRIPT_CONST( ETFCond, TF_COND_SPY_CLASS_STEAL )
