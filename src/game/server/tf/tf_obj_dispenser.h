...
// Mini models
#define MINI_DISPENSER_MODEL_PLACEMENT		"models/buildables/mdispenser_blueprint.mdl"
#define MINI_DISPENSER_MODEL_BUILDING		"models/buildables/mdispenser.mdl"
#define MINI_DISPENSER_MODEL				"models/buildables/mdispenser_light.mdl"
